  ...
  return (
    ...
    >
      <Descriptions column={2} bordered>
        ...
        <Descriptions.Item label="类型">{supplier?.type === 'EQUIPMENT' ? '设备供应商' : supplier?.type === 'CONSUMABLE' ? '易耗品供应商' : supplier?.type === 'MAINTENANCE' ? '维修服务商' : supplier?.type === 'MULTI' ? '多元化供应商' : '-'}</Descriptions.Item>
        ...
        <Descriptions.Item label="评级">{supplier?.rating ? '★'.repeat(supplier.rating) : '-'}</Descriptions.Item>
