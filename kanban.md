...
- [ ] 供应商管理：供应商增删改查、供应商评级、联系方式管理（prds/2026-05-15-供应商管理.md） [QA] 2026-05-15T14:20 ← BUG: 详情页缺少供应商编码/类型/状态/评级字段; BUG: 新增表单提交按钮点击无响应; BUG: EQUIPMENT类型标签显示为易耗品供应商应为设备供应商 [DEV] 2026-05-15T14:24
...
- [ ] 供应商管理 BUG: 详情页缺少供应商编码/类型/状态/评级字段 [QA] 2026-05-15 [PM] 2026-05-15T14:20
